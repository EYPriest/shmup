...
BulletLaserSmall = Class{ __includes = Bullet }

function BulletLaserSmall:init( center_point )
  
  --self.sprite = love.graphics.newImage("res/Enemy Bullets/PinkShot.png")
  --self.sprite = love.graphics.newImage("res/Enemy Bullets/Laser-BlueNoGlow.png")
  self.sprite = love.graphics.newImage("res/Enemy Bullets/Laser-YellowSmall.png")
  ...
  local rotation_direction_x = 1
  local rotation_direction_y = 1
  if ( x_diff < 0 ) then
  ...
  --print( "theta: " .. theta )
  self.rotation_rad = theta * rotation_direction_x * rotation_direction_y
